window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const tint = "color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 14%, transparent)";
		...
		function IconTile({ code, size, tile }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				style: {
					flex: "none",
					display: "inline-flex",
					...
					width: tile,
					height: tile,
					borderRadius: Math.round(tile * .26),
					background: tint,
					color: accent
				},
				dangerouslySetInnerHTML: { __html: weatherIcon(code, size) }
		...
		function RailView({ bundle, status, error, onExpand }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
				...
				children: [now !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					...
					dangerouslySetInnerHTML: { __html: weatherIcon(now.icon, 18) }
