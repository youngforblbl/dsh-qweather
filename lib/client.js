window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function useQWeatherSettings() {
			const [settings, setSettings] = (0, react.useState)(void 0);
			const reload = (0, react.useCallback)(() => {
				fetchQWeatherConfig().then((next) => setSettings(next)).catch(() => {});
			}, []);
			(0, react.useEffect)(() => {
				reload();
				const onChanged = () => reload();
				window.addEventListener(CONFIG_CHANGED_EVENT, onChanged);
				const timer = setInterval(reload, 6e4);
				return () => {
		...
		*/
		...
		function QWeatherSettingsCard(props) {
			...
			const toggleEnabled = () => {
				saveQWeatherConfig({ enabled: !settings.enabled }).catch((cause) => {
					setNotice(t("card.saveFailed") + "：" + (cause instanceof Error ? cause.message : String(cause)));
				});
			};
			const runTest = async () => {
		...
		*/
		let sidebarLayoutStyleEl;
		function ensureSidebarLayoutStyle() {
			if (sidebarLayoutStyleEl !== void 0) return;
			sidebarLayoutStyleEl = document.createElement("style");
			sidebarLayoutStyleEl.textContent = "div:has(> .qw-sidebar-wide),div:has(> div[data-slot=\"sidebar.footer.action\"] > .qw-sidebar-wide){flex-direction:column!important;align-items:stretch!important}div:has(> .qw-sidebar-rail),div:has(> div[data-slot=\"sidebar.footer.action\"] > .qw-sidebar-rail){flex-direction:column!important;align-items:center!important}.qw-sidebar-wide{order:-1;width:100%}";
		...
		const card = {
			...
			border: "1px solid light-dark(rgba(255,255,255,.75),rgba(255,255,255,.10))",
			borderRadius: 16,
			background: "linear-gradient(150deg,light-dark(rgba(255,255,255,.88),rgba(40,55,84,.86)),light-dark(rgba(255,255,255,.55),rgba(17,26,44,.78)))",
			backdropFilter: "blur(14px) saturate(1.15)",
			WebkitBackdropFilter: "blur(14px) saturate(1.15)",
			boxShadow: "-7px -6px 16px light-dark(rgba(56,189,248,.18),rgba(76,141,255,.11)),7px 6px 16px light-dark(rgba(249,115,22,.12),rgba(251,146,60,.08)),0 12px 28px light-dark(rgba(100,116,139,.20),rgba(0,0,0,.45)),8px 8px 20px light-dark(rgba(148,163,184,.42),rgba(0,0,0,.6)),-8px -8px 20px light-dark(rgba(255,255,255,.95),rgba(96,116,150,.16)),inset 0 1px 0 light-dark(rgba(255,255,255,.9),rgba(255,255,255,.07))"
		};
		const row = {
			display: "flex",
			alignItems: "center",
		...
		const hourCell = {
			...
			borderRadius: 11,
			border: "1px solid light-dark(rgba(255,255,255,.75),rgba(255,255,255,.10))",
			background: "linear-gradient(145deg,light-dark(rgba(255,255,255,.85),rgba(46,60,90,.80)),light-dark(rgba(233,239,247,.75),rgba(20,30,50,.72)))",
			boxShadow: "4px 4px 8px light-dark(rgba(148,163,184,.42),rgba(0,0,0,.6)),-3px -3px 7px light-dark(rgba(255,255,255,.95),rgba(96,116,150,.16)),inset 0 1px 0 light-dark(rgba(255,255,255,.95),rgba(255,255,255,.09))"
		};
		const tile = {
			flex: "none",
			display: "inline-flex",
			...
			boxShadow: "4px 4px 10px light-dark(rgba(148,163,184,.42),rgba(0,0,0,.6)),-3px -3px 8px light-dark(rgba(255,255,255,.95),rgba(96,116,150,.16)),inset 0 1px 0 light-dark(rgba(255,255,255,.95),rgba(255,255,255,.09))"
		};
		...
		/** 雨滴图标（标注降水概率指标）。 */
		function Raindrop({ size = 10 }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				style: { display: "inline-flex" },
				dangerouslySetInnerHTML: { __html: raindropIcon(size) }
			});
		}
		/** 风向箭头 + 风级数字。 */
		function WindMark({ degree, scale, dir }) {
			if (degree === void 0 && scale === "") return null;
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
				...
				children: [degree !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					style: {
						display: "inline-flex",
						color: skyDeep
					},
					dangerouslySetInnerHTML: { __html: windArrow(degree, 10) }
				}), scale !== "" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", {
		...
		function DetailSection({ bundle }) {
			...
			if (astro.length > 0) rows.push(/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				style: {
					display: "flex",
					alignItems: "baseline",
					gap: 6,
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: alerts.map((alert) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						style: {
							...
							borderRadius: 9,
							border: "1px solid light-dark(rgba(255,255,255,.75),rgba(255,255,255,.10))",
							borderLeft: "3px solid " + warningColor(alert),
							background: "linear-gradient(150deg,color-mix(in srgb," + warningColor(alert) + " 12%,transparent),transparent 60%)",
							boxShadow: "1px 2px 6px light-dark(rgba(148,163,184,.42),rgba(0,0,0,.6))"
						},
		...
		function WideView({ bundle, status, error, refreshing, onRefresh, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					hours.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						style: {
							display: "flex",
							alignItems: "center",
							gap: 6,
						...
						children: hours.map((hour, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
									...
									children: [round1(hour.temp), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										style: {
											fontSize: 8,
											fontWeight: 800,
											color: orange,
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Raindrop, { size: 10 }), percent(hour.pop)]
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(WindMark, {
									degree: hour.windDegree,
									scale: windScaleLabel(hour.windScale),
									dir: hour.windDir
								})
							]
						}, hour.time))
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(DetailSection, { bundle }),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						style: {
							display: "flex",
							justifyContent: "space-between",
							fontSize: 10,
							color: faint,
							borderTop: "1px dashed light-dark(rgba(255,255,255,.75),rgba(255,255,255,.10))",
							paddingTop: 8
						},
		...
		function SidebarWeatherWidget(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: wide ? "qw-sidebar-wide" : "qw-sidebar-rail",
				style: wide ? void 0 : { display: "contents" },
				children: wide ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(WideView, {
					bundle: state.bundle,
					status: state.status,
					error: state.error,
		...
		*/
		...
		function CardFrame({ meta, callId }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("iframe", {
		...
		*/
		function apply(ctx) {
			...
			const saveAuto = (id, name) => {
				saveQWeatherConfig({
					autoLocationId: id,
					autoLocationName: name
				}).catch(() => {});
			};
			const register = (...args) => ctx.slots.register(...args);
