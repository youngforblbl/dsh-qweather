	...
	factory: (require) => {
		...
		*/
		...
		const hourCell = {
			...
			boxShadow: "inset 2px 2px 5px light-dark(rgba(148,163,184,.42),rgba(0,0,0,.6)),inset -2px -2px 5px light-dark(rgba(255,255,255,.95),rgba(96,116,150,.16))"
		};
		const tile = {
			flex: "none",
			display: "inline-flex",
		...
		*/
		function MiniCurve({ hours }) {
			...
			const xs = hours.map((_, index) => 32 + index * 64);
			const ys = temps.map((temp) => 48 - (temp - min) / span * 26);
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("defs", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("linearGradient", {
						...
						style: {
							fill: "none",
							stroke: "url(#qw-side-chart-stroke)",
							strokeWidth: 9,
					...
					return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						style: {
							position: "absolute",
							left: left + "%",
							top: "calc(" + top.toFixed(1) + "% - 6px)",
							transform: "translate(-50%,-100%)",
							fontSize: 13.5,
							fontWeight: 700,
							color: fg,
							textShadow: "0 1px 0 light-dark(rgba(255,255,255,.6),rgba(0,0,0,.35))",
							...num
						},
		...
		*/
		function AlertRows({ bundle }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				}), alerts.map((alert) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					style: {
						display: "flex",
						flexDirection: "column",
						gap: 3,
					...
					}), alert.text !== void 0 && alert.text.trim().length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						style: {
							fontSize: 10.5,
							color: muted,
							lineHeight: 1.45,
