	...
	factory: (require) => {
		...
		*/
		...
		const card = {
			...
			borderRadius: 16,
			background: "radial-gradient(130% 100% at 10% -10%,light-dark(rgba(56,189,248,.20),rgba(76,141,255,.16)),transparent 46%),radial-gradient(120% 110% at 105% 108%,light-dark(rgba(249,115,22,.12),rgba(251,146,60,.10)),transparent 48%),linear-gradient(150deg,light-dark(rgba(255,255,255,.88),rgba(40,55,84,.86)),light-dark(rgba(255,255,255,.55),rgba(17,26,44,.78)))",
			backdropFilter: "blur(14px) saturate(1.15)",
			WebkitBackdropFilter: "blur(14px) saturate(1.15)",
			boxShadow: "0 12px 28px light-dark(rgba(100,116,139,.20),rgba(0,0,0,.45)),8px 8px 20px light-dark(rgba(148,163,184,.42),rgba(0,0,0,.6)),-8px -8px 20px light-dark(rgba(255,255,255,.95),rgba(96,116,150,.16)),inset 0 1px 0 light-dark(rgba(255,255,255,.9),rgba(255,255,255,.07))"
		};
		const row = {
			display: "flex",
			alignItems: "center",
		...
		*/
		function MiniCurve({ hours }) {
			...
			const area = "M" + xs[0].toFixed(1) + ",56 L" + points + " L" + xs[xs.length - 1].toFixed(1) + ",56 Z";
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				style: {
					position: "relative",
					height: H,
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("polyline", {
							...
							style: {
								fill: "none",
								stroke: "light-dark(rgba(148,163,184,.55),rgba(0,0,0,.5))",
								strokeWidth: 4.5,
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("polyline", {
							...
							style: {
								fill: "none",
								stroke: "light-dark(rgba(255,255,255,.95),rgba(255,255,255,.25))",
								strokeWidth: 1.1,
								strokeLinejoin: "round",
								strokeLinecap: "round",
								opacity: .8,
					...
					return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						style: {
							...
							fontWeight: 700,
							color: fg,
							background: "linear-gradient(150deg,light-dark(rgba(255,255,255,.85),rgba(46,60,90,.80)),light-dark(rgba(233,239,247,.75),rgba(20,30,50,.72)))",
							border: "1px solid light-dark(rgba(255,255,255,.75),rgba(255,255,255,.10))",
							borderRadius: 6,
							padding: "0 4px",
							boxShadow: "1px 2px 4px light-dark(rgba(148,163,184,.42),rgba(0,0,0,.6))",
							...num
						},
						...
						height: 9,
						borderRadius: "50%",
						background: "radial-gradient(circle at 32% 28%,#ffffff,light-dark(#38bdf8,#4c8dff) 78%)",
