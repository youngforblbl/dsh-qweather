	...
	factory: (require) => {
		...
		*/
		...
		const card = {
			...
			boxShadow: "-14px -13px 32px light-dark(rgba(56,189,248,.32),rgba(76,141,255,.20)),14px 13px 32px light-dark(rgba(249,115,22,.22),rgba(251,146,60,.13)),0 12px 28px light-dark(rgba(100,116,139,.20),rgba(0,0,0,.45)),8px 8px 20px light-dark(rgba(148,163,184,.42),rgba(0,0,0,.6)),-8px -8px 20px light-dark(rgba(255,255,255,.95),rgba(96,116,150,.16)),inset 0 1px 0 light-dark(rgba(255,255,255,.9),rgba(255,255,255,.07))"
		};
		const row = {
			display: "flex",
			alignItems: "center",
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("polyline", {
							...
							style: {
								fill: "none",
								stroke: "light-dark(rgba(0,0,0,.26),rgba(0,0,0,.55))",
								strokeWidth: 3.6,
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("polyline", {
							...
							style: {
								fill: "none",
								stroke: "light-dark(rgba(255,255,255,.95),rgba(255,255,255,.22))",
								strokeWidth: 1,
								strokeLinejoin: "round",
								strokeLinecap: "round",
								opacity: .8,
