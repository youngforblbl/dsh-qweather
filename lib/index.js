...
function tempChartSvg(hours) {
	...
	return `<div class="qw-chart">${`<svg class="qw-chart-svg" viewBox="0 0 ${CHART_W} ${CHART_H}" preserveAspectRatio="none" aria-hidden="true"><defs><linearGradient id="qw-chart-stroke" gradientUnits="userSpaceOnUse" x1="0" y1="34" x2="0" y2="84"><stop offset="0%" style="stop-color:var(--orange)"/><stop offset="100%" style="stop-color:var(--sky)"/></linearGradient></defs><path class="qw-chart-shadow" d="${line}" transform="translate(0,2.2)" style="stroke:light-dark(rgba(0,0,0,.22),rgba(0,0,0,.5))"/><path class="qw-chart-line" d="${line}" stroke="url(#qw-chart-stroke)"/><path class="qw-chart-ridge" d="${line}" transform="translate(0,-4.2)" style="stroke:light-dark(rgba(255,255,255,.95),rgba(255,255,255,.22))"/></svg>`}${hours.map((hour, index) => {
